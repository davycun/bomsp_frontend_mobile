    ...
    <div>
        <van-popup v-model="editVisible" :position="position" :style="{height:height,width:width}">
            <van-form @submit="onEditSubmitOk" label-align="right" colon scroll-to-error style="margin-bottom: 50px">
                ...
                <van-field label="周转场地" type="number"
                           name="openSpaceAcreage"
                ...
                <van-field label="有无月台" name="hasRailway" :rules="[{validator:trueOrFalseValidator,message:'有无杭车必填'}]">
                    <template #input>
                ...
                <van-field v-if="currentData.hasRailway==true" label="月台类型" name="railwayType"
                    ...
                    <template #input>
                        <van-radio-group v-model="currentData.railwayType" direction="horizontal">
                            <van-radio v-for="dic in railwayType" :name="dic.code" :key="dic.code">{{dic.name}}
                            </van-radio>
                        </van-radio-group>
                    </template>
                </van-field>
                ...
                <van-field v-if="railwayWidthNeed" label="月台宽度"
                           type="number"
                           name="railwayWidth"
                           v-model="currentData.railwayWidth"
                           placeholder="外置式月台的宽度"
                           :rules="[{required: railwayWidthNeed,message:'月台高度必填'}]">
                    <template #button>米</template>
                </van-field>
                <van-field label="雨棚" name="hasCanopy"
                           :rules="[{validator:trueOrFalseValidator,message:'雨棚必填'}]">
                    <template #input>
                ...
                <van-field v-if="currentData.hasCanopy===true" label="雨棚宽度"
                           type="number"
                           name="canopyWidth"
                           v-model="currentData.canopyWidth"
                           placeholder="雨棚宽度宽度"
                ...
                <van-field label="卸货面" name="uploadType" :rules="[{required: true,message:'卸货面必填'}]">
                    <template #input>
                        <van-radio-group v-model="currentData.uploadType" direction="horizontal">
                            <van-radio v-for="dic in uploadType" :name="dic.code" :key="dic.code">{{dic.name}}
                            </van-radio>
                        </van-radio-group>
                    </template>
                </van-field>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            railwayType: {
                get() {
                    return dictionaryStorage.get("com.cii.bomsp.house.industry.dictionary.RailwayType")
                }
            },
            uploadType: {
                get() {
                    return dictionaryStorage.get("com.cii.bomsp.house.industry.dictionary.UploadType")
                }
            },
        },
        ...
        methods: {
            ...
            doRequest() {
                ...
                let _url = this.editor ? "warehouse/update" : "warehouse/create";
